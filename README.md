...
# How This Works 
When user asks question, Langchain pulls relevent chunks from document store and retrieve context from LLM prompt. Rather than have LLM gather information from training, it is given source documents to answer from, while also nudging LLM to look for evidence via online reosurces to support their claim. 
